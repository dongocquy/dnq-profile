...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-yellow-500/20 bg-gradient-to-r from-gray-900/95 via-purple-900/30 to-gray-900/95 animate-fade-in-up shadow-lg shadow-purple-500/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          {/* Logo */}
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2 group">
              <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-yellow-400 via-gold to-yellow-600 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-105 group-hover:rotate-2 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 to-pink-500/20 animate-pulse"></div>
                <span className="text-gray-900 font-bold text-sm relative z-10">DNQ</span>
              </div>
              <span className="font-bold text-xl text-gold group-hover:text-yellow-400 transition-colors duration-200">
